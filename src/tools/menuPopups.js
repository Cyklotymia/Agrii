    ...
    addListeners = () => {
        ...
        this.buttons.forEach(button => {
            button.addEventListener("click", (e) => {
                const valueOfDataset = e.target.closest(`[${this.dataName}]`).getAttribute(`${this.dataName}`);
                const allElementsWithSameDatasetName = this.container.querySelectorAll(`[${this.dataName}=${valueOfDataset}]`);
